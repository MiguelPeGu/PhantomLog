    ...
    public function run(): void
    {
        ...
        $reports = [
            [
                ...
                'image'       => 'images/reports/belmonte_shadow.jpg',
                'score'       => 34,
            ],
            [
                ...
                'image'       => 'images/reports/monasterio_piedra.jpg',
                'score'       => 21,
            ],
            [
                ...
                'image'       => 'images/reports/emf_comparison.jpg',
                'score'       => 57,
            ],
            [
                ...
                'image'       => 'images/reports/segovia_cemetery.jpg',
                'score'       => 45,
            ],
            [
                ...
                'image'       => 'images/reports/cuenca_house.jpg',
                'score'       => 72,
            ],
        ];
        ...
        // Ensure every forum has at least 1 and at most 5 reports
        foreach ($forums as $forum) {
            $currentCount = $forum->reports()->count();
            $targetCount = rand(1, 5);
            
            if ($currentCount < $targetCount) {
                \App\Models\Report::factory()->count($targetCount - $currentCount)->create([
                    'forum_id' => $forum->id,
