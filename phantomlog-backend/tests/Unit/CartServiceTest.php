...
it('increases quantity if product is already in cart', function (): void {
    $product = Product::factory()->make(['id' => '1', 'price' => 100, 'tax' => 21]);
...
it('can subtract quantity from the cart', function (): void {
    $product = Product::factory()->make(['id' => '1', 'price' => 100, 'tax' => 21]);
...
it('removes product from cart if subtracted quantity goes below 1', function (): void {
    $product = Product::factory()->make(['id' => '1', 'price' => 100, 'tax' => 21]);
...
it('can clear the cart completely', function (): void {
    $product = Product::factory()->make(['id' => '1', 'price' => 100, 'tax' => 21]);
...
it('calculates total without tax correctly', function (): void {
...
it('calculates total with tax correctly', function (): void {
    // 100 + 21% = 121
    $product = Product::factory()->make(['id' => '1', 'price' => 100, 'tax' => 21]);
